...
programming and algorithm track at ALX Africa SE . The program is a pseudo-
...
int main(void)
{
	char *street = "Tom Mobya St.", *city = "Nairobi", *state = "KE";

	_printf("%d %s, %s, %s %d\n", 21, street, city, state, 20400);
}
```
Output:
```
21 Tom Mboya St., Nairobi, KE 20400
```
...
* Noel Osiro <[noelosiro](https://github.com/noelosiro)>
* Isacko Godana <[isackogodana](https://github.com/)>
...
This program was written as part of the curriculum for ALX Software Engineering School.

<p align="center">
  <img src="https://lh3.googleusercontent.com/Ac1cTLN5PaGfFTBiv6SOIVjDX47DrQcEhwEi0SJHU6mkk0vDsyOmBJhoa3bwkclUT9fs-NKgz_i9CRqz85iw_FusHaddlTl53xk=s0" alt="ALX Africa logo">
</p>
